...
// import { Crypto } from "@/components/chatbot/tools/cryptoprice";
// import { ContractSource } from "@/components/chatbot/tools/ContractSource";
// import { Sendstx } from "@/components/chatbot/tools/SendStx";
...
export default function Message({ message }: { message: Message }) {
  ...
  console.log("tools", hasTools, message);
  const isProcessing =
    hasTools &&
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="space-y-3">
            {message.toolInvocations?.map((tool) => {
              ...
              console.log(toolName, toolCallId, state);
